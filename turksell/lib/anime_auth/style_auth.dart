...
class StyleAuth{
 ...
 static InputDecoration getInputDecorationDay({String hint,String label,Widget icon}){
    ...
    return InputDecoration(
      ...
      focusedBorder: getOutLineBorder(width: 1,color:ProjectColors.bgIconDark,radius:2),
      enabledBorder: getOutLineBorder(width: 1.5,color:ProjectColors.bgIconDark,radius:2),
      errorBorder: getOutLineBorder(width: 1.5,color:ProjectColors.bgIconDark,radius:2),
      focusedErrorBorder:getOutLineBorder(width: 1.5,color:ProjectColors.bgIconDark,radius:2),
    );
  }
