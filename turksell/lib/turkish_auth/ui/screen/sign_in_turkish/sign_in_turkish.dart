...
@provide
class SignInTurkish extends StatefulWidget {
  @override
  _SignInTurkishState createState() => _SignInTurkishState();
}

class _SignInTurkishState extends State<SignInTurkish> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: getInputDecorationDay(
  ...
  InputDecoration getInputDecorationDay({String hint="",String label="",Widget icon}){
    ...
    return InputDecoration(
     ...
     // labelText: "$hint",
      ...
      focusedBorder: StyleAuth.getOutLineBorder(width: 1,color:ProjectColors.bgIconDark,radius:2),
      enabledBorder:StyleAuth.getOutLineBorder(width: 1.5,color:ProjectColors.bgIconDark,radius:2),
      errorBorder:StyleAuth.getOutLineBorder(width: 1.5,color:ProjectColors.bgIconDark,radius:2),
      focusedErrorBorder:StyleAuth.getOutLineBorder(width: 1.5,color:ProjectColors.bgIconDark,radius:2),
    );
  }
}
